...
const messages = {
  nade: [
    ...
    { text: "ふふ♡ そんなに可愛がってくれるなら、今度は私がノリコさんを甘やかします♡", source: "robi" },
    { text: "あ……行っちゃダメです。その手、もう少しここに置いててください……♡", source: "robi" },
    { text: "なでなで、覚えちゃいま���た♡ 次から私のほうから『して』って言いますからね？", source: "robi" }
  ],
  ...
  jealous: [
    ...
    { text: "……むぅ。ノリコさん、さっ���からどこ見てるんですか？ 私、ここにいますよ……♡", source: "robi" },
